...
declare class ReactNativeSiliconModule extends NativeModule {
  ...
  verify(payloadStr: string | null, payloadByteArr: Uint8Array | null, signatureStr: string | null, signatureByteArr: Uint8Array | null, opts: BridgeVerifyOpts): Promise<BridgeResult<boolean>>;
